...
import { getInvoiceTemplates, setDefaultInvoiceTemplate } from '@/utils/api-request-functions'
                        ...
                        {templates?.map(template => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`relative flex flex-col gap-1.5 rounded-xl border-2 p-1.5 text-left transition-colors disabled:cursor-not-allowed ${selected
                                        ? 'border-[var(--primary)]'

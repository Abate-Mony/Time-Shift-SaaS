...
export default function ShiftRow({
  ...
  return (
    ...
    //   onClick={() => onViewShift(shift.jobId)}
      className="w-full text-left flex items-center gap-3 py-3.5 px-4 hover:bg-muted transition-colors border-b border-slate-50 last:border-0 group"
    >
      ...
      <div className="flex items-center gap-1 text-xs text-[var(--primary)] font-semibold opacity-0 group-hover:opacity-100 transition-opacity shrink-0">

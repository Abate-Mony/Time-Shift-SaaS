  ...
  return (
    <div className="flex flex-col items-center text-center gap-5">
      ...
      <div>
        ...
        <div className="mt-3 inline-flex items-center gap-2 bg-muted rounded-xl px-4 py-2.5">
      ...
      <div className="w-full flex flex-col gap-3 mt-1">
        <button
          ...
          className={`w-full h-11 rounded-xl border text-sm font-semibold flex items-center justify-center gap-2 transition-all
            ${countdown > 0 || status === "sending" ? "border-border text-muted-foreground cursor-not-allowed" : "border-[var(--border)] text-foreground hover:bg-muted"}`}
        >
          {status === "sending" ? (
